...
# sha256_of_file / collect_notebook_tree(s) live in
# clm.core.utils.jupyterlite_manifest (Phase 8 S1, #802) — the build
# operation computes the same manifest host-side for the cache key.
