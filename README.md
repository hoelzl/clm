...
**Version**: 1.14.0 | **License**: MIT | **Python**: 3.12, 3.13, 3.14
...
- **Mobile Deck Editor**: Edit deck files from your phone over the LAN (`clm edit`) — an offline, browser-based cell editor that writes straight to the source files with byte-for-byte preservation of untouched cells
