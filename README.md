...
- **Slide Authoring Tools**: Topic resolution (`clm resolve-topic`), fuzzy search (`clm search-slides`), and structured JSON outlines (`clm outline --format json`) for AI-assisted slide authoring
