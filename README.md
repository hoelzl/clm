...
- **Slide Authoring Tools**: Topic resolution (`clm resolve-topic`), fuzzy search (`clm search-slides`), spec validation (`clm validate-spec`), and structured JSON outlines (`clm outline --format json`) for AI-assisted slide authoring
