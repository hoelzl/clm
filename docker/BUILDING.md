...
**Image Tags:**
- `docker.io/mhoelzl/clm-plantuml-converter:1.22.1`
...
**Image Tags:**
- `docker.io/mhoelzl/clm-drawio-converter:1.22.1`
...
**Image Tags:**
- `docker.io/mhoelzl/clm-notebook-processor:1.22.1-lite`
...
**Image Tags:**
- `docker.io/mhoelzl/clm-notebook-processor:1.22.1` (default)
...
- IJava 1.22.1 (Java Jupyter kernel)
...
- **Full (default):** `docker.io/mhoelzl/clm-notebook-processor:latest`, `:1.22.1`, `:full`, `:1.22.1-full`
- **Lite:** `docker.io/mhoelzl/clm-notebook-processor:lite`, `:1.22.1-lite`
