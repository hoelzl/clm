...
**Image Tags:**
- `mhoelzl/clm-plantuml-converter:1.0.3`
...
**Image Tags:**
- `mhoelzl/clm-drawio-converter:1.0.3`
...
**Image Tags:**
- `mhoelzl/clm-notebook-processor:1.0.3-lite`
...
**Image Tags:**
- `mhoelzl/clm-notebook-processor:1.0.3` (default)
- `mhoelzl/clm-notebook-processor:1.0.3-full`
...
- **Full (default):** `mhoelzl/clm-notebook-processor:latest`, `:1.0.3`, `:full`, `:1.0.3-full`
- **Lite:** `mhoelzl/clm-notebook-processor:lite`, `:1.0.3-lite`
