...
**Image Tags:**
- `mhoelzl/clm-plantuml-converter:1.0.4`
...
**Image Tags:**
- `mhoelzl/clm-drawio-converter:1.0.4`
...
**Image Tags:**
- `mhoelzl/clm-notebook-processor:1.0.4-lite`
...
**Image Tags:**
- `mhoelzl/clm-notebook-processor:1.0.4` (default)
...
- **Full (default):** `mhoelzl/clm-notebook-processor:latest`, `:1.0.4`, `:full`, `:1.0.4-full`
- **Lite:** `mhoelzl/clm-notebook-processor:lite`, `:1.0.4-lite`
