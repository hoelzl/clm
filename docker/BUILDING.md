...
**Image Tags:**
- `docker.io/mhoelzl/clm-plantuml-converter:1.28.0`
...
**Image Tags:**
- `docker.io/mhoelzl/clm-drawio-converter:1.28.0`
...
**Image Tags:**
- `docker.io/mhoelzl/clm-notebook-processor:1.28.0-lite`
...
**Image Tags:**
- `docker.io/mhoelzl/clm-notebook-processor:1.28.0` (default)
- `docker.io/mhoelzl/clm-notebook-processor:1.28.0-full`
...
- **Full (default):** `docker.io/mhoelzl/clm-notebook-processor:latest`, `:1.28.0`, `:full`, `:1.28.0-full`
- **Lite:** `docker.io/mhoelzl/clm-notebook-processor:lite`, `:1.28.0-lite`
