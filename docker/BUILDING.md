...
**Image Tags:**
- `docker.io/mhoelzl/clm-plantuml-converter:1.3.3`
...
**Image Tags:**
- `docker.io/mhoelzl/clm-drawio-converter:1.3.3`
...
**Image Tags:**
- `docker.io/mhoelzl/clm-notebook-processor:1.3.3-lite`
...
**Image Tags:**
- `docker.io/mhoelzl/clm-notebook-processor:1.3.3` (default)
- `docker.io/mhoelzl/clm-notebook-processor:1.3.3-full`
...
- IJava 1.3.3 (Java Jupyter kernel)
...
- **Full (default):** `docker.io/mhoelzl/clm-notebook-processor:latest`, `:1.3.3`, `:full`, `:1.3.3-full`
- **Lite:** `docker.io/mhoelzl/clm-notebook-processor:lite`, `:1.3.3-lite`
...
- `docker/notebook/ijava-1.3.3.zip` (~6MB) - **LFS**
