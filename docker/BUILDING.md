...
**Image Tags:**
- `mhoelzl/clm-plantuml-converter:1.0.2`
...
**Image Tags:**
- `mhoelzl/clm-drawio-converter:1.0.2`
...
**Image Tags:**
- `mhoelzl/clm-notebook-processor:1.0.2-lite`
...
**Image Tags:**
- `mhoelzl/clm-notebook-processor:1.0.2` (default)
- `mhoelzl/clm-notebook-processor:1.0.2-full`
...
- **Full (default):** `mhoelzl/clm-notebook-processor:latest`, `:1.0.2`, `:full`, `:1.0.2-full`
- **Lite:** `mhoelzl/clm-notebook-processor:lite`, `:1.0.2-lite`
