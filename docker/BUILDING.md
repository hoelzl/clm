...
**Image Tags:**
- `docker.io/mhoelzl/clm-plantuml-converter:1.0.9`
...
**Image Tags:**
- `docker.io/mhoelzl/clm-drawio-converter:1.0.9`
...
**Image Tags:**
- `docker.io/mhoelzl/clm-notebook-processor:1.0.9-lite`
...
**Image Tags:**
- `docker.io/mhoelzl/clm-notebook-processor:1.0.9` (default)
- `docker.io/mhoelzl/clm-notebook-processor:1.0.9-full`
...
- **Full (default):** `docker.io/mhoelzl/clm-notebook-processor:latest`, `:1.0.9`, `:full`, `:1.0.9-full`
- **Lite:** `docker.io/mhoelzl/clm-notebook-processor:lite`, `:1.0.9-lite`
