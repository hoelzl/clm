...
**Image Tags:**
- `docker.io/mhoelzl/clm-plantuml-converter:1.1.2`
...
**Image Tags:**
- `docker.io/mhoelzl/clm-drawio-converter:1.1.2`
...
**Image Tags:**
- `docker.io/mhoelzl/clm-notebook-processor:1.1.2-lite`
...
**Image Tags:**
- `docker.io/mhoelzl/clm-notebook-processor:1.1.2` (default)
- `docker.io/mhoelzl/clm-notebook-processor:1.1.2-full`
...
- **Full (default):** `docker.io/mhoelzl/clm-notebook-processor:latest`, `:1.1.2`, `:full`, `:1.1.2-full`
- **Lite:** `docker.io/mhoelzl/clm-notebook-processor:lite`, `:1.1.2-lite`
