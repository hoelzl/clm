...
**Image Tags:**
- `docker.io/mhoelzl/clm-plantuml-converter:1.23.0`
...
**Image Tags:**
- `docker.io/mhoelzl/clm-drawio-converter:1.23.0`
...
**Image Tags:**
- `docker.io/mhoelzl/clm-notebook-processor:1.23.0-lite`
...
**Image Tags:**
- `docker.io/mhoelzl/clm-notebook-processor:1.23.0` (default)
- `docker.io/mhoelzl/clm-notebook-processor:1.23.0-full`
...
- IJava 1.23.0 (Java Jupyter kernel)
...
- **Full (default):** `docker.io/mhoelzl/clm-notebook-processor:latest`, `:1.23.0`, `:full`, `:1.23.0-full`
- **Lite:** `docker.io/mhoelzl/clm-notebook-processor:lite`, `:1.23.0-lite`
