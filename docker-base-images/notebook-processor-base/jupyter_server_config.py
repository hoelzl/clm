...
#  Default: ''
c.ServerApp.password = 'argon2:$argon2id$v=19$m=10240,t=10,p=8$pxR1iI8cyn87MljOflduiw$KHjnt+fiQTvuLkJc7pduF1IoK8p1MVFaAwcJf9eINRw'
...
#  Choices: any of ['sha1', 'sha3_224', 'sha384', 'blake2b', 'blake2s', 'sha224', 'sha3_512', 'sha256', 'md5', 'sha3_384', 'sha3_256', 'sha512']
#  Default: 'sha256'
