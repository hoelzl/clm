...
**Version**: 1.1.4 | **License**: MIT | **Python**: 3.11, 3.12, 3.13, 3.14
...
```
clm/
├── src/clm/                    # CLM package source (v1.1.4)
│   ├── core/                   # Domain logic
...
│   ├── workers/                # Worker implementations (v1.1.4)
...
### LLM-Powered Course Summaries (v1.1.4+)
...
### Git Amend and Force Push (v1.1.4+)
...
### Git Remote URL Template (v1.1.4+)
...
### Markdown Notebook Files and Project Documents (v1.1.4+)
