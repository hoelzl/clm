...
**Version**: 1.1.7 | **License**: MIT | **Python**: 3.11, 3.12, 3.13, 3.14
...
```
clm/
├── src/clm/                    # CLM package source (v1.1.7)
│   ├── core/                   # Domain logic
...
│   ├── workers/                # Worker implementations (v1.1.7)
...
### LLM-Powered Course Summaries (v1.1.7+)
...
### Git Amend and Force Push (v1.1.7+)
...
### Git Remote URL Template (v1.1.7+)
...
### Markdown Notebook Files and Project Documents (v1.1.7+)
