...
```
clm/
├── src/clm/                    # CLM package source (v1.1.6)
│   ├── core/                   # Domain logic
...
│   ├── workers/                # Worker implementations (v1.1.6)
...
### LLM-Powered Course Summaries (v1.1.6+)
...
### Git Amend and Force Push (v1.1.6+)
...
### Git Remote URL Template (v1.1.6+)
...
### Markdown Notebook Files and Project Documents (v1.1.6+)
