...
`allow-untranslated` tag as the explicit escape hatch. What `record_neutral`
banks here can therefore no longer *silently* contain unmarked German — it
failed validation first, or was deliberately declared.
