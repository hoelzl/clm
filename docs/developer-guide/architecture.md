...
This document describes the current architecture of the CLM system (v1.0.1).
...
**Purpose**: Concrete worker implementations for different file types (v1.0.1)
...
**v0.6.2 → v1.0.1** (2025): Integrated workers
