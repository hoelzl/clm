...
This document describes the current architecture of the CLX system (v0.5.0).
...
**Purpose**: Concrete worker implementations for different file types (NEW in v0.5.0)
...
**v0.5.0** (November 2025): Integrated workers
