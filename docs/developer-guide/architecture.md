...
This document describes the current architecture of the CLM system (v1.1.3).
...
**Purpose**: Concrete worker implementations for different file types (v1.1.3)
...
**v0.6.2 → v1.1.3** (2025): Integrated workers
