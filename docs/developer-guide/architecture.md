...
This document describes the current architecture of the CLX system (v0.6.1).
...
**Purpose**: Concrete worker implementations for different file types (NEW in v0.6.1)
...
**v0.6.1** (November 2025): Integrated workers
