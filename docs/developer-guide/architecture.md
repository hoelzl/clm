...
This document describes the current architecture of the CLM system (v1.19.0).
...
**Purpose**: Concrete worker implementations for different file types (v1.19.0)
...
**v0.6.2 → v1.19.0** (2025): Integrated workers
