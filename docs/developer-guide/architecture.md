...
This document describes the current architecture of the CLM system (v1.0.5).
...
**Purpose**: Concrete worker implementations for different file types (v1.0.5)
...
**v0.6.2 → v1.0.5** (2025): Integrated workers
