...
This document describes the current architecture of the CLM system (v1.3.3).
...
**Purpose**: Concrete worker implementations for different file types (v1.3.3)
...
**v0.6.2 → v1.3.3** (2025): Integrated workers
