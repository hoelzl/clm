...
- **[Video Narration Harvest](harvest.md)** - Recover narration from recorded videos into decks
- **[Voiceover Text Layer](voiceover.md)** - Companion files: extract/inline written narration
