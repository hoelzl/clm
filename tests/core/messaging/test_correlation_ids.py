...
from clm.core.messaging.correlation_ids import (
    CorrelationData,
...
class TestNoteCorrelationIdDependency:
    ...
    async def test_ignores_nonexistent_id(self, caplog):
        ...
        with caplog.at_level(logging.ERROR, logger="clm.core.messaging.correlation_ids"):
    ...
    async def test_warns_inactive_id(self, caplog):
        ...
        with caplog.at_level(logging.WARNING, logger="clm.core.messaging.correlation_ids"):
            await note_correlation_id_dependency(cid, dep)
...
class TestRemoveCorrelationId:
    ...
    async def test_handles_missing_id(self, caplog):
        ...
        # Should not raise
        with caplog.at_level(logging.DEBUG, logger="clm.core.messaging.correlation_ids"):
