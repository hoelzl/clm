...
def update_imports(file_path: Path) -> bool:
    ...
    replacements = [
        ...
        (r'from clx_common\.backends import',
         r'from clx.infrastructure.backends import'),
        ...
        (r'from clx_common\.services import',
         r'from clx.infrastructure.services import'),
        (r'from clx_common\.utils import',
         r'from clx.infrastructure.utils import'),
        (r'from clx_common\.operation import',
         r'from clx.infrastructure.operation import'),
        (r'from clx_common import',
         r'from clx.infrastructure import'),
        (r'import clx_common\.',
         r'import clx.infrastructure.'),
        (r'import clx_common$',
         r'import clx.infrastructure'),
        ...
        (r'from clx_cli\.file_event_handler import',
         r'from clx.cli.file_event_handler import'),
        (r'from clx_cli\.git_dir_mover import',
         r'from clx.cli.git_dir_mover import'),
        ...
        (r'from clx\.course_file import',
         r'from clx.core.course_file import'),
        (r'from clx\.course_spec import',
         r'from clx.core.course_spec import'),
        (r'from clx\.section import',
         r'from clx.core.section import'),
        (r'from clx\.topic import',
         r'from clx.core.topic import'),
        (r'from clx\.dir_group import',
         r'from clx.core.dir_group import'),
    ]
